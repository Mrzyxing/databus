...
/**
 *
 * Databus client cluster info. Typical use is for client load-balancing.
 */
public class DbusClusterInfo
{
  ...
  {
    return "DbusClusterInfo [name=" + _name +"; totalPartitions=" + _totalPartitions +
           "; minActiveNodes=" + _minActiveNodes + "]";
  }
}
