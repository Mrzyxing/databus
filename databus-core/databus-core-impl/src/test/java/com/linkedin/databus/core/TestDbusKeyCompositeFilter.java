...
{
  private static final DbusEventFactory _eventFactory = new DbusEventV1Factory();
                              ...
                              List<DbusEvent> eventVector)
  {
    ...
    try
    {
      for (int i = 0; i < numEvents; ++i)
      {
        ...
        DbusEventFactory.serializeEvent(new DbusEventKey(keys.get((index++)%size)), buf, eventInfo);
        eventVector.add(DbusEventFactoryForTesting.createReadOnlyDbusEventFromBuffer(buf, 0, windowScn,
