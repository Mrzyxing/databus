...
public interface DatabusClusterDataNotifier
{
        ...
        /**
         *
         * @param activeNodes List of activeNodes in the cluster
        ...
        /**
         *
         * @param activePartitionMap Map of partition->id (node id) of those partitions actively serviced by nodes
         */
